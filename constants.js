...
const actionWords = [
    "act", "read", "agree", "arrive", "ask", "bake", "bring", "build", "buy", 
    "call", "climb", "close", "come", "cry", "dance", "dream", "drink", "eat", 
    "enter", "exit", "fall", "fix", "give", "go", "grab", "help", "hit", "hop", 
    "insult", "joke", "jump", "kick", "laugh", "leave", "lift", "listen", "make", 
    "march", "move", "nod", "open", "play", "push", "ride", "run", "send", "shout", 
    "sing", "sit", "smile", "spend", "stand", "talk", "think", "throw", "touch", 
    "turn", "visit", "vote", "wait", "walk", "write", "yell"
];

const actions = {
    "time": new Date().toTimeString(),
    "call" : (name) => {return `Calling ${name}`},
